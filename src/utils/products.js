...
import phone05 from "../Images/phone09.png";
...
export const SliderData = [
  {
    ...
    desc: "To make your shopping experience even better, we're offering an exclusive 50% discount on your first purchase. Whether you're shopping for trendy clothes, gadgets, home decor, or more, now is the perfect time to make your first purchase and save big!",
    cover: apple,
  },
  {
    id: 2,
...
export const serviceData = [
  {
    ...
    title: "Free Shipping",
    subtitle: "Shop your favorites and have them delivered right to your doorstep—absolutely free! No hidden fees, no minimum purchase required.",
    bg: "#fdefe6",
  },
  {
    icon: <ion-icon name="card"></ion-icon>,
    title: "Safe Payment",
    subtitle: "Your security is our priority. Enjoy safe and secure payment options with advanced encryption and trusted gateways.",
    bg: "#ceebe9",
  },
  {
  ...
  },
  {
    ...
    subtitle: "We’ve got you covered with our money-back guarantee. If you’re not completely satisfied with your purchase, we’ll ensure a hassle-free refund.",
    bg: "#d6e5fb",
  },
];
